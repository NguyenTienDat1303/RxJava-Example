package com.example.rxjavademo.activity.tmdb_project.model;
...
public class MovieDBResponse {
    ...
    public final static Parcelable.Creator<MovieDBResponse> CREATOR = new Parcelable.Creator<MovieDBResponse>() {
