...
public class AsyncObservableActivity extends AppCompatActivity {
    ...
    void asyncSubject() {
        ...
        asyncSubject.subscribe(getObserverFirst());
        asyncSubject.subscribe(getObserverSecond());
        asyncSubject.subscribe(getObserverThird());
    }
