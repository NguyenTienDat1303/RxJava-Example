...
public class ReplayObservableActivity extends AppCompatActivity {
    ...
    void publishSubject() {
        ...
        replaySubject.subscribe(getObserverFirst());
        replaySubject.subscribe(getObserverSecond());
        replaySubject.subscribe(getObserverThird());
