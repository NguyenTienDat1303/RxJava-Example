package com.example.rxjavademo.activity.todo_project.fragment;
...
import com.example.rxjavademo.activity.todo_project.activity.AddToDoActivity;
import com.example.rxjavademo.activity.todo_project.adapter.RecyclerTouchListener;
import com.example.rxjavademo.activity.todo_project.adapter.ToDoListAdapter;
import com.example.rxjavademo.activity.todo_project.data.ToDoDataManager;
import com.example.rxjavademo.activity.todo_project.data.ToDoListItem;
                ...
                RxTextView.textChangeEvents(searchEditText)
                        ...
                        .subscribeWith(new DisposableObserver<TextViewTextChangeEvent>() {
                            ...
                            public void onNext(TextViewTextChangeEvent textViewTextChangeEvent) {
                                Log.i("onNext", textViewTextChangeEvent.getText().toString());
